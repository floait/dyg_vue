<template>
  <div class="donut">
    <svg viewBox="0 0 100 100" transform="rotate(-150)" xmlns="http://www.w3.org/2000/svg" class="donut__svg">
      ...
      <circle id="donut-graph" v-bind:style="styleObject" :r="radius" :cy="cy" :cx="cx" stroke-width="5" stroke="rgba(0,0,0,0)"
              stroke-linejoin="round" stroke-linecap="round" stroke-opacity="0.7" fill="none"  transform="rotate(-90 50 50)"/>

      <path id="lessNormal" stroke="red" stroke-width="5" stroke-opacity="0.5"  stroke-linejoin="round" stroke-linecap="round" :d="offset.less"></path>
      <path id="normal" stroke="blue" stroke-width="5" stroke-opacity="0.5"  stroke-linejoin="round" stroke-linecap="round" :d="offset.normal"></path>
      <path id="moreNormal" stroke="yellow" stroke-width="5" stroke-opacity="0.5"  stroke-linejoin="round" stroke-linecap="round" :d="offset.more"></path>
      <defs>
...
<script>
  import {describeArc, polarToCartesian} from '../features/utils'
  ...
  export default {
    ...
    methods: {
      computeOffsets: function () {
        ...
        let lessEndAngle = lessEndAngleNum * 300
        ...
        let normalAngle = normalAngleNum * 300
        ...
        let moreEndAngle = moreEndAngleNum * 300
